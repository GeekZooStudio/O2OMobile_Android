...
@Table(name = "orderlistpublishedRequest")
public class orderlistpublishedRequest  extends DataBaseModel
{
     ...
     public void  fromJson(JSONObject jsonObject)  throws JSONException
     {
          ...
          this.published_order = jsonObject.optInt("published_order");
     ...
     public JSONObject  toJson() throws JSONException 
     {
          ...
          localItemObject.put("published_order", published_order);
